...
class Validator extends BaseValidator
{
     ...
     * @return string|null
     */
    private function getValidateType(array $rules): ?string
    {
        return match (true) {
            isset($rules['required']) => 'required',
            isset($rules['type']) => 'type',
            isset($rules['confirm']) => 'confirm',
            isset($rules['enum']) => 'enum',
            isset($rules['regex']) => 'regex',
            isset($rules['validateFunction']) => 'validateFunction',
            (isset($rules['min']) && isset($rules['max'])) => 'between',
            isset($rules['min']) => 'min',
            isset($rules['max']) => 'max',
            default => null,
        };
